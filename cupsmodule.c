...
#define STR_CONSTANT(name)					\
  ...
  // IPP operations
  INT_CONSTANT (IPP_OP_PRINT_JOB);
  INT_CONSTANT (IPP_OP_PRINT_URI);
  INT_CONSTANT (IPP_OP_VALIDATE_JOB);
  INT_CONSTANT (IPP_OP_CREATE_JOB);
  INT_CONSTANT (IPP_OP_SEND_DOCUMENT);
  INT_CONSTANT (IPP_OP_SEND_URI);
  INT_CONSTANT (IPP_OP_CANCEL_JOB);
  INT_CONSTANT (IPP_OP_GET_JOB_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_GET_JOBS);
  INT_CONSTANT (IPP_OP_GET_PRINTER_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_HOLD_JOB);
  INT_CONSTANT (IPP_OP_RELEASE_JOB);
  INT_CONSTANT (IPP_OP_RESTART_JOB);
  INT_CONSTANT (IPP_OP_PAUSE_PRINTER);
  INT_CONSTANT (IPP_OP_RESUME_PRINTER);
  INT_CONSTANT (IPP_OP_PURGE_JOBS);
  INT_CONSTANT (IPP_OP_SET_PRINTER_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_SET_JOB_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_GET_PRINTER_SUPPORTED_VALUES);
  INT_CONSTANT (IPP_OP_CREATE_PRINTER_SUBSCRIPTIONS);
  INT_CONSTANT (IPP_OP_CREATE_JOB_SUBSCRIPTIONS);
  INT_CONSTANT (IPP_OP_GET_SUBSCRIPTIONS);
  INT_CONSTANT (IPP_OP_RENEW_SUBSCRIPTION);
  INT_CONSTANT (IPP_OP_CANCEL_SUBSCRIPTION);
  INT_CONSTANT (IPP_OP_GET_NOTIFICATIONS);
  INT_CONSTANT (IPP_OP_SEND_NOTIFICATIONS);
  INT_CONSTANT (IPP_OP_GET_RESOURCE_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_GET_RESOURCE_DATA);
  INT_CONSTANT (IPP_OP_GET_RESOURCES);
  INT_CONSTANT (IPP_OP_GET_PRINT_SUPPORT_FILES);
  INT_CONSTANT (IPP_OP_ENABLE_PRINTER);
  INT_CONSTANT (IPP_OP_DISABLE_PRINTER);
  INT_CONSTANT (IPP_OP_PAUSE_PRINTER_AFTER_CURRENT_JOB);
  INT_CONSTANT (IPP_OP_HOLD_NEW_JOBS);
  INT_CONSTANT (IPP_OP_RELEASE_HELD_NEW_JOBS);
  INT_CONSTANT (IPP_OP_DEACTIVATE_PRINTER);
  INT_CONSTANT (IPP_OP_ACTIVATE_PRINTER);
  INT_CONSTANT (IPP_OP_RESTART_PRINTER);
  INT_CONSTANT (IPP_OP_SHUTDOWN_PRINTER);
  INT_CONSTANT (IPP_OP_STARTUP_PRINTER);
  INT_CONSTANT (IPP_OP_REPROCESS_JOB);
  INT_CONSTANT (IPP_OP_CANCEL_CURRENT_JOB);
  INT_CONSTANT (IPP_OP_SUSPEND_CURRENT_JOB);
  INT_CONSTANT (IPP_OP_RESUME_JOB);
  INT_CONSTANT (IPP_OP_PROMOTE_JOB);
  INT_CONSTANT (IPP_OP_SCHEDULE_JOB_AFTER);
  INT_CONSTANT (IPP_OP_CANCEL_DOCUMENT);
  INT_CONSTANT (IPP_OP_GET_DOCUMENT_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_GET_DOCUMENTS);
  INT_CONSTANT (IPP_OP_DELETE_DOCUMENT);
  INT_CONSTANT (IPP_OP_SET_DOCUMENT_ATTRIBUTES);
  INT_CONSTANT (IPP_OP_CANCEL_JOBS);
  INT_CONSTANT (IPP_OP_CANCEL_MY_JOBS);
  INT_CONSTANT (IPP_OP_RESUBMIT_JOB);
  INT_CONSTANT (IPP_OP_CLOSE_JOB);
  INT_CONSTANT (IPP_OP_IDENTIFY_PRINTER);
  INT_CONSTANT (IPP_OP_VALIDATE_DOCUMENT);
  INT_CONSTANT (IPP_OP_SEND_HARDCOPY_DOCUMENT);
  INT_CONSTANT (IPP_OP_CUPS_GET_DEFAULT);
  INT_CONSTANT (IPP_OP_CUPS_GET_PRINTERS);
  INT_CONSTANT (IPP_OP_CUPS_ADD_MODIFY_PRINTER);
  INT_CONSTANT (IPP_OP_CUPS_DELETE_PRINTER);
  INT_CONSTANT (IPP_OP_CUPS_GET_CLASSES);
  INT_CONSTANT (IPP_OP_CUPS_ADD_MODIFY_CLASS);
  INT_CONSTANT (IPP_OP_CUPS_DELETE_CLASS);
  INT_CONSTANT (IPP_OP_CUPS_ACCEPT_JOBS);
  INT_CONSTANT (IPP_OP_CUPS_REJECT_JOBS);
  INT_CONSTANT (IPP_OP_CUPS_SET_DEFAULT);
  INT_CONSTANT (IPP_OP_CUPS_GET_DEFAULT);
  INT_CONSTANT (IPP_OP_CUPS_GET_PPDS);
  INT_CONSTANT (IPP_OP_CUPS_MOVE_JOB);
  INT_CONSTANT (IPP_OP_CUPS_AUTHENTICATE_JOB);
  INT_CONSTANT (IPP_OP_CUPS_GET_PPD);
  INT_CONSTANT (IPP_OP_CUPS_GET_DOCUMENT);

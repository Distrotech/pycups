...
#  define INT_IPP_OP_CONSTANT(name)					\
  ...
  INT_IPP_OP_CONSTANT (CANCEL_DOCUMENT);
  INT_IPP_OP_CONSTANT (GET_DOCUMENT_ATTRIBUTES);
  INT_IPP_OP_CONSTANT (GET_DOCUMENTS);
  INT_IPP_OP_CONSTANT (DELETE_DOCUMENT);
  INT_IPP_OP_CONSTANT (SET_DOCUMENT_ATTRIBUTES);
